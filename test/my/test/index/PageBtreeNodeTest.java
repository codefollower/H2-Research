...
public class PageBtreeNodeTest {
	//重点测试find
	public static void main(String[] args) throws Exception {
		...
		stmt.executeUpdate("CREATE TABLE IF NOT EXISTS IndexTestTable(id int not null, name varchar(500) not null, address varchar(500))");
		...
		//stmt.executeUpdate("CREATE index IF NOT EXISTS idx_name ON IndexTestTable(name desc)");
				...
				//stmt.executeUpdate("insert into IndexTestTable(id, name) values(" + 101 + ", '" + s + "abcdef1234')");
