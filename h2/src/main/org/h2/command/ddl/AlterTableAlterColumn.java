...
public class AlterTableAlterColumn extends CommandWithColumns {
    ...
    public long update() {
        ...
        case CommandInterface.ALTER_TABLE_ALTER_COLUMN_NOT_NULL: {
            ...
            checkNoNullValues(table); //如果要修改的列有NULL值，那么不允许把列修改为NOT NULL
        ...
        case CommandInterface.ALTER_TABLE_ALTER_COLUMN_DROP_NOT_NULL: {
            ...
            checkNullable(table); //如果要修改的列是主键索引或hash索引的列，那么不允许把列修改为NULL
...
//>>>>>>> d9a7cf0dcb563abb69ed313f35cdebfebe544674
        ...
        for (Column col : newColumns) {
            ...
            if (seq != null) {
                ...
                //因为newColumns中的列是通过Clone得来，所以就算之后检查view失败了也不会影响原来的列
