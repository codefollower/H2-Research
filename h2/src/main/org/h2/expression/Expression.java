...
//=======
     ...
     * @return the result
     */
    public boolean getBooleanValue(SessionLocal session) { //没有字类覆盖
     ...
     */
    public String getColumnName(SessionLocal session, int columnIndex) { //只有子类Alias和ExpressionColumn覆盖了此方法
     ...
     */
    public String getAlias(SessionLocal session, int columnIndex) { //只有子类Alias和ExpressionColumn覆盖了此方法
