...
public abstract class Table extends SchemaObjectBase {
     ...
     */
    public abstract void checkSupportAlter(); //ֻ��MVTable��RegularTable֧��
     ...
     * @return true if it is
     */
    public abstract boolean isDeterministic(); //��TableLink��false��FunctionTable��TableViewҪ������������������෵��true
    ...
    @Override
    public String getCreateSQLForCopy(Table table, String quotedName) { //ֻ��TableView������
    ...
    //Table��children��6��: index��constraint��trigger��sequence��view��right
    @Override
     ...
     * @return true if it is
     */
    public boolean isLockedExclusivelyBy(Session session) { //ֻ��RegularTable��MVTable���Ǵ˷���
        return false;
    }
    ...
    public void updateRows(Prepared prepared, Session session, RowList rows) {
        ...
        for (rows.reset(); rows.hasNext();) {
            ...
            rows.next(); 
            try {
                //Ϊʲô�����ȼǳ�����־��ɾ�����أ���Ϊ��������Ļ�����ɾ���в��ɹ���������־�ǳɹ��ˣ���rollbackʱ�ְ���־��insert����
                //��ʱ�Ͷ���һ����¼�ˣ�
                //�Ǽ���ǳ�����־ʧ������? ���������ֵģ���Ϊsession.log�н�һ��������org.h2.engine.UndoLog.add(UndoLogRecord)
                //���UndoLog.add�����ĵ�һ�оͰ�UndoLogRecord���ӵ�records�У�ֻҪ�ϸ�ȷ���ڳ����κ��쳣ǰ�ȼ���records��
                //��ô��rollback�о����ҵ�֮ǰ��ɾ�����С�
                removeRow(session, o);
            } catch (DbException e) {
