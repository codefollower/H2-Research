...
//=======
     ...
     */
    public Value copy(DataHandler handler, int tableId) { //只对ValueLob、ValueLobDb有用
        return this;
    }
     ...
     */
    public boolean isLinkedToTable() { //只对ValueLob、ValueLobDb有用
        return false;
    }
     ...
     */
    public void remove() { //只对ValueLob、ValueLobDb有用
        // nothing to do
    }
